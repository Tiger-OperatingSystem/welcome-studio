...
namespace welcome
{
  class MainWindow : Window
  {
    ...
    [UI] private readonly RadioButton _radioButtonLime= null;
    ...
    private MainWindow(Builder builder) : base(builder.GetRawOwnedObject("MainWindow"))
    {
      ...
      _radioButtonLime.Clicked += RadioButtonLimeClicked;
    ...
    private void RadioButtonLimeClicked(object sender, EventArgs e) => ApplyThemesRadioButtons("Lime");
